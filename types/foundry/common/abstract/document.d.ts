...
declare global {
	module foundry {
		module abstract {
			...
			abstract class Document {
				 ...
				 */
				static migrateData<TSource extends DocumentSource>(
					source: TSource,
				): TSource;
				...
				getEmbeddedCollection(
					embeddedName: string,
				): abstract.EmbeddedCollection<Document>;
	...
	type PreDocumentId<T extends foundry.abstract.DocumentSource> = Omit<
		T,
		'_id'
	> & { _id: null };
	...
	type DocumentUpdateData<
		T extends foundry.abstract.Document = foundry.abstract.Document,
	> = Partial<T['_source']> | Record<string, unknown>;

	type EmbeddedDocumentUpdateData<T extends foundry.abstract.Document> =
